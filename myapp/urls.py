...
# from .views import login_view, register_view, forgot_password_view, home_view,  add_bestie_view, edit_profile, chat_view
# from django.contrib.auth.views import LogoutView
# from .views import search_bestie,add_bestie, bestie_list, remove_bestie,bestie_inbox,accept_bestie,cancel_bestie_request,logout_view
...
from .views import (
    ...
    search_bestie, add_bestie, bestie_list, remove_bestie,
    bestie_inbox, accept_bestie, cancel_bestie_request
)
...
urlpatterns = [
    ...
    path('add-bestie/<int:user_id>/', add_bestie, name='add_bestie_action'),
    path('search-bestie/', search_bestie, name='search_bestie'),
    path('my-besties/', bestie_list, name='bestie_list'),
    path('accept-bestie/<int:user_id>/', accept_bestie, name='accept_bestie'),
    path('remove-bestie/<int:user_id>/', remove_bestie, name='remove_bestie'),
